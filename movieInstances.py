# -*- coding: cp1252 -*-  #
# While adding "poster_image and trailer_youtube" I guess some special
# charecters were added. Then I got an error saying non ASCII charecters
# are inserted and I ended up clicking "Edit my life" and voila above
# string was added to my code.
# StackOverflow told me this -->{"If you are file contains some special
# non ASCII character like "®"then IDE will add this line at the
# starting of your file.If you remove that line from the starting
# of file then non ASCII character wont be recognized."}
...
hp1 = media.Movie("Harry Potter & the Philosopher's Stone (2001)",
                  ...
                  "uncle, a young boy with a great destiny proves"
                  "his worth while attending"
...
hp3 = media.Movie("Harry Potter & the Prisoner of Azkaban (2004)",
                  ...
                  "not only does he have a new Defense Against the Dark"
                  "Arts teacher, but there is also trouble brewing."
                  "Convicted murderer Sirius Black has escaped the"
...
hp4 = media.Movie("Harry Potter & the Goblet of Fire (2005)",
                  "A young wizard finds himself competing in a hazardous"
                  "tournament between rival schools of magic,"
...
hp5 = media.Movie("Harry Potter & the Order of the Phoenix (2007)",
                  "With their warning about Lord Voldemort's return"
...
hp6 = media.Movie("Harry Potter & the Half-Blood Prince (2009)",
                  ...
                  "he discovers an old book marked as the property"
                  "of the Half-Blood Prince and begins to learn more"
...
hp7 = media.Movie("Harry Potter & the Deathly Hallows: Part 1 (2010)",
                  ...
                  "estroy the Horcruxes,he uncovers the"
